...
- Manual unblock: `bash scripts/security_unblock.sh <ip> [reason]` removes the IP from local state, logs `SECURITY UNBAN`, and deletes the Cloudflare access rule when tokens are configured.
